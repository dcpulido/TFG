...
if (entity.equalsIgnoreCase("WorkProduct")) {
        ...
        if (entity.equalsIgnoreCase("DPDFSMMat")) {
            DPDFSMMat nentity=new DPDFSMMat(((Model)getModel()).getNewId("DPDFSMMat"));
            DefaultGraphCell vertex = new
        ...
        if (entity.equalsIgnoreCase("DPDFS")) {
            DPDFS nentity=new DPDFS(((Model)getModel()).getNewId("DPDFS"));
            DefaultGraphCell vertex = new
            DPDFSCell(nentity);
            // Default Size for the cell with the new entity
            return vertex;
        ...
        if (entity.equalsIgnoreCase("DPDFSMMop")) {
            DPDFSMMop nentity=new DPDFSMMop(((Model)getModel()).getNewId("DPDFSMMop"));
            DefaultGraphCell vertex = new
