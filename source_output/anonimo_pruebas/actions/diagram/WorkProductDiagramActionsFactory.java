...
if (ent.getClass().getName().equals("ingenias.editor.entities.WorkProduct")){
        ...
        if (ent.getClass().getName().equals("ingenias.editor.entities.DPDFS")){
            final ViewPreferences.ViewType current1=ViewPreferences.ViewType.UML;
            possibleViews.add(new AbstractAction("UML") {
                public void actionPerformed(ActionEvent e) {                
                    ent.getPrefs().setView(ViewPreferences.ViewType.UML);
        ...
        if (ent.getClass().getName().equals("ingenias.editor.entities.none")){
            possibleViews.add(new AbstractAction("NOICON") {
                public void actionPerformed(ActionEvent e) {
                    ingenias.editor.cell.RenderComponentManager.setRelationshipView(ViewPreferences.ViewType.NOICON, ent, cell, graph);
                    graph.repaint();
        ...
        if (ent.getClass().getName().equals("ingenias.editor.entities.QQ")){
            possibleViews.add(new AbstractAction("NOICON") {
                public void actionPerformed(ActionEvent e) {
                    ingenias.editor.cell.RenderComponentManager.setRelationshipView(ViewPreferences.ViewType.NOICON, ent, cell, graph);
                    graph.repaint();
        ...
        if (ent.getClass().getName().equals("ingenias.editor.entities.relates")){
            possibleViews.add(new AbstractAction("NOICON") {
                public void actionPerformed(ActionEvent e) {
                    ingenias.editor.cell.RenderComponentManager.setRelationshipView(ViewPreferences.ViewType.NOICON, ent, cell, graph);
                    graph.repaint();
        ...
        if (ent.getClass().getName().equals("ingenias.editor.entities.QR")){
            possibleViews.add(new AbstractAction("NOICON") {
                public void actionPerformed(ActionEvent e) {
                    ingenias.editor.cell.RenderComponentManager.setRelationshipView(ViewPreferences.ViewType.NOICON, ent, cell, graph);
                    graph.repaint();
        ...
        if (ent.getClass().getName().equals("ingenias.editor.entities.QD")){
            possibleViews.add(new AbstractAction("NOICON") {
                public void actionPerformed(ActionEvent e) {
                    ingenias.editor.cell.RenderComponentManager.setRelationshipView(ViewPreferences.ViewType.NOICON, ent, cell, graph);
                    graph.repaint();
        ...
        if (ent.getClass().getName().equals("ingenias.editor.entities.defines")){
            possibleViews.add(new AbstractAction("NOICON") {
                public void actionPerformed(ActionEvent e) {
                    ingenias.editor.cell.RenderComponentManager.setRelationshipView(ViewPreferences.ViewType.NOICON, ent, cell, graph);
                    graph.repaint();
        ...
        if (ent.getClass().getName().equals("ingenias.editor.entities.quotes")){
            possibleViews.add(new AbstractAction("NOICON") {
                public void actionPerformed(ActionEvent e) {
                    ingenias.editor.cell.RenderComponentManager.setRelationshipView(ViewPreferences.ViewType.NOICON, ent, cell, graph);
                    graph.repaint();
...
protected Vector<AbstractAction> createDiagramSpecificInsertActions(final Point pt, final ModelJGraph graph) {
        ...
        nobjects.add(
                     new AbstractAction("Insert DPDFS") {
            public void actionPerformed(ActionEvent ev) {
                try {
                    graph.insert(pt, "DPDFS");
                } catch (InvalidEntity e) {                     
                    e.printStackTrace();
                    JOptionPane.showMessageDialog(graph, "Object type DPDFS is not allowed in this diagram",
                                                  "Warning", JOptionPane.WARNING_MESSAGE);
                }
            }
        });
