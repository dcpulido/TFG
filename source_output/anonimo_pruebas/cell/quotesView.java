...
public class quotesView extends NAryView {

static quotesRenderer renderer1 = new quotesRenderer();

  // Constructor.
  public quotesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.quotes ent=(ingenias.editor.entities.quotes)((DefaultGraphCell)this.getCell()).getUserObject();
