...
public class FreeWPRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
	...
	static {
		...
		try {
			...
			RenderComponentManager.loadRenderFile("FreeWP",
												  index,"/ingenias/editor/rendererxml/FreeWPUMLPanel.xml");
			
			index=ViewPreferences.ViewType.INGENIAS;
			RenderComponentManager.loadRenderFile("FreeWP",
												  index,"/ingenias/editor/rendererxml/FreeWPINGENIASPanel.xml");
     ...
     */
    public FreeWPRenderer() {
    }
	
    public Dimension getSize() {
		return RenderComponentManager.getSize("FreeWP",current);
    }
	...
	public static void setEntity(FreeWP ent){
		Map currentMap=(Map)  RenderComponentManager.retrieveIDs("FreeWP",ent.getPrefs().getView());
	...
	{
		return RenderComponentManager.retrievePanel("FreeWP",
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("FreeWP",current);
	}
