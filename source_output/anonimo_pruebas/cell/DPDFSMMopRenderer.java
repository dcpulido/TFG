...
public class DPDFSMMopRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("DPDFSMMop",
	index,"/ingenias/editor/rendererxml/DPDFSMMopUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("DPDFSMMop",
	index,"/ingenias/editor/rendererxml/DPDFSMMopINGENIASPanel.xml");
     ...
     */
    public DPDFSMMopRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("DPDFSMMop",current);
    }
  ...
  public static void setEntity(DPDFSMMop ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("DPDFSMMop",ent.getPrefs().getView());
	...
	{
	return RenderComponentManager.retrievePanel("DPDFSMMop",
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("DPDFSMMop",current);
	}
