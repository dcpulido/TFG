...
public class UMLSpecificationView extends VertexView {

  public static UMLSpecificationRenderer renderer = new UMLSpecificationRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public UMLSpecificationView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
		ingenias.editor.entities.UMLSpecification ent=(ingenias.editor.entities.UMLSpecification)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(UMLSpecification ent) {
