...
public class WorkProductStructureDiagramActionsFactory extends DiagramMenuEntriesActionsFactory  implements java.io.Serializable {
    
    public WorkProductStructureDiagramActionsFactory(GUIResources resources, IDEState state){
