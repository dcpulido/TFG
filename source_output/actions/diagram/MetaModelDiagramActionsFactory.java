...
public class MetaModelDiagramActionsFactory extends DiagramMenuEntriesActionsFactory  implements java.io.Serializable {
    
    public MetaModelDiagramActionsFactory(GUIResources resources, IDEState state){
...
if (ent.getClass().getName().equals("ingenias.editor.entities.DPDFSMMel")){
        ...
        if (ent.getClass().getName().equals("ingenias.editor.entities.Related")){
        ...
        if (ent.getClass().getName().equals("ingenias.editor.entities.Composition")){
            possibleViews.add(new AbstractAction("NOICON") {
                public void actionPerformed(ActionEvent e) {
                    ingenias.editor.cell.RenderComponentManager.setRelationshipView(ViewPreferences.ViewType.NOICON, ent, cell, graph);
                    graph.repaint();
        ...
        if (ent.getClass().getName().equals("ingenias.editor.entities.Aggregation")){
            possibleViews.add(new AbstractAction("NOICON") {
                public void actionPerformed(ActionEvent e) {
                    ingenias.editor.cell.RenderComponentManager.setRelationshipView(ViewPreferences.ViewType.NOICON, ent, cell, graph);
                    graph.repaint();
        ...
        if (ent.getClass().getName().equals("ingenias.editor.entities.Association")){
            possibleViews.add(new AbstractAction("NOICON") {
                public void actionPerformed(ActionEvent e) {
                    ingenias.editor.cell.RenderComponentManager.setRelationshipView(ViewPreferences.ViewType.NOICON, ent, cell, graph);
                    graph.repaint();
