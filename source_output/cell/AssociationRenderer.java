...
public class AssociationRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("Association",
    index,"/ingenias/editor/rendererxml/AssociationNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("Association",
    index,"/ingenias/editor/rendererxml/AssociationINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("Association",
    index,"/ingenias/editor/rendererxml/AssociationLABELPanel.xml");
    ...
    return RenderComponentManager.getSize("Association",current);
    }
 ...
 public static void setEntity(Association ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Association",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("Association",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("Association",c);
    }
