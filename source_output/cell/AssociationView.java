...
public class AssociationView extends NAryView {

static AssociationRenderer renderer1 = new AssociationRenderer();

  // Constructor.
  public AssociationView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.Association ent=(ingenias.editor.entities.Association)((DefaultGraphCell)this.getCell()).getUserObject();
