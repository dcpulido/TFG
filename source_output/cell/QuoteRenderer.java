...
public class QuoteRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("Quote",
    index,"/ingenias/editor/rendererxml/QuoteNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("Quote",
    index,"/ingenias/editor/rendererxml/QuoteINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("Quote",
    index,"/ingenias/editor/rendererxml/QuoteLABELPanel.xml");
     ...
     */
     public QuoteRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("Quote",current);
    }
 ...
 public static void setEntity(Quote ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Quote",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("Quote",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("Quote",c);
    }
