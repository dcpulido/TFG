...
public class RelatedRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("Related",
    index,"/ingenias/editor/rendererxml/RelatedNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("Related",
    index,"/ingenias/editor/rendererxml/RelatedINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("Related",
    index,"/ingenias/editor/rendererxml/RelatedLABELPanel.xml");
     ...
     */
     public RelatedRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("Related",current);
    }
 ...
 public static void setEntity(Related ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Related",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("Related",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("Related",c);
    }
