...
public class QuoteRelationshipRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("QuoteRelationship",
    index,"/ingenias/editor/rendererxml/QuoteRelationshipNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("QuoteRelationship",
    index,"/ingenias/editor/rendererxml/QuoteRelationshipINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("QuoteRelationship",
    index,"/ingenias/editor/rendererxml/QuoteRelationshipLABELPanel.xml");
     ...
     */
     public QuoteRelationshipRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("QuoteRelationship",current);
    }
 ...
 public static void setEntity(QuoteRelationship ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("QuoteRelationship",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("QuoteRelationship",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("QuoteRelationship",c);
    }
