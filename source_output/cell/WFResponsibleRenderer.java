...
public class WFResponsibleRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("WFResponsible",
    index,"/ingenias/editor/rendererxml/WFResponsibleNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("WFResponsible",
    index,"/ingenias/editor/rendererxml/WFResponsibleINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("WFResponsible",
    index,"/ingenias/editor/rendererxml/WFResponsibleLABELPanel.xml");
     ...
     */
     public WFResponsibleRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("WFResponsible",current);
    }
 ...
 public static void setEntity(WFResponsible ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFResponsible",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("WFResponsible",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("WFResponsible",c);
    }
