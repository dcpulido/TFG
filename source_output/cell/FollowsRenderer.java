...
public class FollowsRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("Follows",
    index,"/ingenias/editor/rendererxml/FollowsNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("Follows",
    index,"/ingenias/editor/rendererxml/FollowsINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("Follows",
    index,"/ingenias/editor/rendererxml/FollowsLABELPanel.xml");
     ...
     */
     public FollowsRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("Follows",current);
    }
 ...
 public static void setEntity(Follows ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Follows",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("Follows",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("Follows",c);
    }
