...
public class DefineView extends NAryView {

static DefineRenderer renderer1 = new DefineRenderer();

  // Constructor.
  public DefineView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.Define ent=(ingenias.editor.entities.Define)((DefaultGraphCell)this.getCell()).getUserObject();
