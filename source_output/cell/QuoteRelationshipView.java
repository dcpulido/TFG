...
public class QuoteRelationshipView extends NAryView {

static QuoteRelationshipRenderer renderer1 = new QuoteRelationshipRenderer();

  // Constructor.
  public QuoteRelationshipView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.QuoteRelationship ent=(ingenias.editor.entities.QuoteRelationship)((DefaultGraphCell)this.getCell()).getUserObject();
