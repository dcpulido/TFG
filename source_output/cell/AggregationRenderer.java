...
public class AggregationRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("Aggregation",
    index,"/ingenias/editor/rendererxml/AggregationNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("Aggregation",
    index,"/ingenias/editor/rendererxml/AggregationINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("Aggregation",
    index,"/ingenias/editor/rendererxml/AggregationLABELPanel.xml");
     ...
     */
     public AggregationRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("Aggregation",current);
    }
 ...
 public static void setEntity(Aggregation ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Aggregation",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("Aggregation",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("Aggregation",c);
    }
