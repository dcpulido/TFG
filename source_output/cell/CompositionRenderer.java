...
public class CompositionRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("Composition",
    index,"/ingenias/editor/rendererxml/CompositionNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("Composition",
    index,"/ingenias/editor/rendererxml/CompositionINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("Composition",
    index,"/ingenias/editor/rendererxml/CompositionLABELPanel.xml");
    ...
    return RenderComponentManager.getSize("Composition",current);
    }
 ...
 public static void setEntity(Composition ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Composition",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("Composition",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("Composition",c);
    }
