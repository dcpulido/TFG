...
public class WFResponsibleView extends NAryView {

static WFResponsibleRenderer renderer1 = new WFResponsibleRenderer();

  // Constructor.
  public WFResponsibleView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.WFResponsible ent=(ingenias.editor.entities.WFResponsible)((DefaultGraphCell)this.getCell()).getUserObject();
