...
public class QuoteView extends NAryView {

static QuoteRenderer renderer1 = new QuoteRenderer();

  // Constructor.
  public QuoteView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.Quote ent=(ingenias.editor.entities.Quote)((DefaultGraphCell)this.getCell()).getUserObject();
