...
public class relatesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("relates",
    index,"/ingenias/editor/rendererxml/relatesNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("relates",
    index,"/ingenias/editor/rendererxml/relatesINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("relates",
    index,"/ingenias/editor/rendererxml/relatesLABELPanel.xml");
     ...
     */
     public relatesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("relates",current);
    }
 ...
 public static void setEntity(relates ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("relates",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("relates",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("relates",c);
    }
