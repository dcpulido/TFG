...
public class RelateRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("Relate",
    index,"/ingenias/editor/rendererxml/RelateNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("Relate",
    index,"/ingenias/editor/rendererxml/RelateINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("Relate",
    index,"/ingenias/editor/rendererxml/RelateLABELPanel.xml");
     ...
     */
     public RelateRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("Relate",current);
    }
 ...
 public static void setEntity(Relate ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Relate",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("Relate",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("Relate",c);
    }
