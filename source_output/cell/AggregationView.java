...
public class AggregationView extends NAryView {

static AggregationRenderer renderer1 = new AggregationRenderer();

  // Constructor.
  public AggregationView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.Aggregation ent=(ingenias.editor.entities.Aggregation)((DefaultGraphCell)this.getCell()).getUserObject();
