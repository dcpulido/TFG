...
public class ExtendsRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("Extends",
    index,"/ingenias/editor/rendererxml/ExtendsNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("Extends",
    index,"/ingenias/editor/rendererxml/ExtendsINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("Extends",
    index,"/ingenias/editor/rendererxml/ExtendsLABELPanel.xml");
     ...
     */
     public ExtendsRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("Extends",current);
    }
 ...
 public static void setEntity(Extends ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Extends",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("Extends",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("Extends",c);
    }
