...
public class RelateView extends NAryView {

static RelateRenderer renderer1 = new RelateRenderer();

  // Constructor.
  public RelateView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.Relate ent=(ingenias.editor.entities.Relate)((DefaultGraphCell)this.getCell()).getUserObject();
