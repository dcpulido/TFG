...
public class WpContainsView extends NAryView {

static WpContainsRenderer renderer1 = new WpContainsRenderer();

  // Constructor.
  public WpContainsView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.WpContains ent=(ingenias.editor.entities.WpContains)((DefaultGraphCell)this.getCell()).getUserObject();
