...
public class DefineRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("Define",
    index,"/ingenias/editor/rendererxml/DefineNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("Define",
    index,"/ingenias/editor/rendererxml/DefineINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("Define",
    index,"/ingenias/editor/rendererxml/DefineLABELPanel.xml");
     ...
     */
     public DefineRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("Define",current);
    }
 ...
 public static void setEntity(Define ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Define",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("Define",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("Define",c);
    }
