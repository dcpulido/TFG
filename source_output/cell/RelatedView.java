...
public class RelatedView extends NAryView {

static RelatedRenderer renderer1 = new RelatedRenderer();

  // Constructor.
  public RelatedView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.Related ent=(ingenias.editor.entities.Related)((DefaultGraphCell)this.getCell()).getUserObject();
