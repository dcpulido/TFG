...
public class ActivityDetailedDiagramDataEntityWidgetPreferences extends EntityWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public ActivityDetailedDiagramDataEntityWidgetPreferences() {
  super();
