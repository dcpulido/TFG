...
public class WorkProductDependecyDiagramDataEntityWidgetPreferences extends EntityWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public WorkProductDependecyDiagramDataEntityWidgetPreferences() {
  super();
