...
public class WorkProductStructureDiagramDataEntityWidgetPreferences extends EntityWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public WorkProductStructureDiagramDataEntityWidgetPreferences() {
  super();
