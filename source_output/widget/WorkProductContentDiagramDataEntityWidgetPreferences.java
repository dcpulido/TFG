...
public class WorkProductContentDiagramDataEntityWidgetPreferences extends EntityWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public WorkProductContentDiagramDataEntityWidgetPreferences() {
  super();
