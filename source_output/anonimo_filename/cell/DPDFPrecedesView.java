...
public class DPDFPrecedesView extends NAryView {
	
	static DPDFPrecedesRenderer renderer1 = new DPDFPrecedesRenderer();
	
	// Constructor.
	public DPDFPrecedesView(Object cell) {
		super(cell);
	}
	...
	public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
		...
		try {
			ingenias.editor.entities.DPDFPrecedes ent=(ingenias.editor.entities.DPDFPrecedes)((DefaultGraphCell)this.getCell()).getUserObject();
