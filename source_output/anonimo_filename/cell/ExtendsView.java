...
public class ExtendsView extends NAryView {

static ExtendsRenderer renderer1 = new ExtendsRenderer();

  // Constructor.
  public ExtendsView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.Extends ent=(ingenias.editor.entities.Extends)((DefaultGraphCell)this.getCell()).getUserObject();
