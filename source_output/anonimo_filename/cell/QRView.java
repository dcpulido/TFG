...
public class QRView extends NAryView {

static QRRenderer renderer1 = new QRRenderer();

  // Constructor.
  public QRView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.QR ent=(ingenias.editor.entities.QR)((DefaultGraphCell)this.getCell()).getUserObject();
