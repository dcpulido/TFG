...
public class definesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("defines",
    index,"/ingenias/editor/rendererxml/definesNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("defines",
    index,"/ingenias/editor/rendererxml/definesINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("defines",
    index,"/ingenias/editor/rendererxml/definesLABELPanel.xml");
     ...
     */
     public definesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("defines",current);
    }
 ...
 public static void setEntity(defines ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("defines",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("defines",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("defines",c);
    }
