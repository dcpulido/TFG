...
public class FollowsView extends NAryView {

static FollowsRenderer renderer1 = new FollowsRenderer();

  // Constructor.
  public FollowsView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.Follows ent=(ingenias.editor.entities.Follows)((DefaultGraphCell)this.getCell()).getUserObject();
