...
public class WFProducesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("WFProduces",
    index,"/ingenias/editor/rendererxml/WFProducesNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("WFProduces",
    index,"/ingenias/editor/rendererxml/WFProducesINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("WFProduces",
    index,"/ingenias/editor/rendererxml/WFProducesLABELPanel.xml");
     ...
     */
     public WFProducesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("WFProduces",current);
    }
 ...
 public static void setEntity(WFProduces ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFProduces",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("WFProduces",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("WFProduces",c);
    }
