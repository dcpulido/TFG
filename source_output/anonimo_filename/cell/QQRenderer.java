...
public class QQRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("QQ",
    index,"/ingenias/editor/rendererxml/QQNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("QQ",
    index,"/ingenias/editor/rendererxml/QQINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("QQ",
    index,"/ingenias/editor/rendererxml/QQLABELPanel.xml");
    ...
    return RenderComponentManager.getSize("QQ",current);
    }
 ...
 public static void setEntity(QQ ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("QQ",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("QQ",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("QQ",c);
    }
