...
this.addClass("Extendssource","ingenias.editor.entities.MentalState");
     
    
     this.addRole("Extendstarget");
     this.setArity("Extendstarget",true,1);
     this.setArity("Extendstarget",false,2147483647);
     
this.addClass("Extendstarget","ingenias.editor.entities.MentalEntity");
     
this.addClass("Extendstarget","ingenias.editor.entities.MentalInstanceSpecification");
