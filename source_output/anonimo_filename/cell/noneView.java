...
public class noneView extends NAryView {

static noneRenderer renderer1 = new noneRenderer();

  // Constructor.
  public noneView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.none ent=(ingenias.editor.entities.none)((DefaultGraphCell)this.getCell()).getUserObject();
