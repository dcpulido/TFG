...
public class WFResponsableRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("WFResponsable",
    index,"/ingenias/editor/rendererxml/WFResponsableNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("WFResponsable",
    index,"/ingenias/editor/rendererxml/WFResponsableINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("WFResponsable",
    index,"/ingenias/editor/rendererxml/WFResponsableLABELPanel.xml");
 ...
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFResponsable",ent.getPrefs().getView());
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("WFResponsable",c);
    }
