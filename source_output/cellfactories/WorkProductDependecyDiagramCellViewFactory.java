...
public class WorkProductDependecyDiagramCellViewFactory implements CellViewFactory {
    
    public WorkProductDependecyDiagramCellViewFactory () {}
...
if (userObject.getClass().equals(FreeWP.class)){
        ...
        if (userObject.getClass().equals(Work Product.class)){
            return new Work ProductView(v);
        }
        ...
        if (v.getClass().equals(WP DependsEdge.class)){
            return new WP DependsView(v);
        }
