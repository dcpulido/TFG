...
public class StructuredWPWidgetPreferences extends AgentComponentWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public StructuredWPWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","MinValue","CurrentValue","MaxValue",""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("CurrentValue",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("CurrentValue",result);
  
   preferredWidget.put("MinValue",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("MinValue",result);
  
   preferredWidget.put("MaxValue",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("MaxValue",result);
