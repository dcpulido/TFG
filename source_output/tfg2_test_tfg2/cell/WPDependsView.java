...
public class WPDependsView extends NAryView {
	
	static WPDependsRenderer renderer1 = new WPDependsRenderer();
	
	// Constructor.
	public WPDependsView(Object cell) {
		super(cell);
	}
	...
	public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
		...
		try {
			ingenias.editor.entities.WPDepends ent=(ingenias.editor.entities.WPDepends)((DefaultGraphCell)this.getCell()).getUserObject();
