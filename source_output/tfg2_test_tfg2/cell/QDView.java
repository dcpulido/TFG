...
public class QDView extends NAryView {

static QDRenderer renderer1 = new QDRenderer();

  // Constructor.
  public QDView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.QD ent=(ingenias.editor.entities.QD)((DefaultGraphCell)this.getCell()).getUserObject();
