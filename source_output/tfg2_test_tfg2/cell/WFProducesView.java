...
public class WFProducesView extends NAryView {

static WFProducesRenderer renderer1 = new WFProducesRenderer();

  // Constructor.
  public WFProducesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.WFProduces ent=(ingenias.editor.entities.WFProduces)((DefaultGraphCell)this.getCell()).getUserObject();
