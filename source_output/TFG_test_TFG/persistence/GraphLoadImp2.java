...
implements GraphLoad {
	...
	protected DefaultGraphCell GXLVertex(String id, String type, ModelJGraph graph,
		...
		if (en != null) {
			...
			//System.out.println("La entidad leida es: "+en.getId());
			...
			if (en.getClass().equals(ingenias.editor.entities.WorkProduct.class)) 
				return  new ingenias.editor.cell.WorkProductCell((WorkProduct)en);
			
			if (en.getClass().equals(ingenias.editor.entities.BehaviourWP.class)) 
				return  new ingenias.editor.cell.BehaviourWPCell((BehaviourWP)en);
			
			if (en.getClass().equals(ingenias.editor.entities.FreeWP.class)) 
				return  new ingenias.editor.cell.FreeWPCell((FreeWP)en);
			
			if (en.getClass().equals(ingenias.editor.entities.StructuralWP.class)) 
				return  new ingenias.editor.cell.StructuralWPCell((StructuralWP)en);
			
			if (en.getClass().equals(ingenias.editor.entities.StructuredWP.class)) 
				return  new ingenias.editor.cell.StructuredWPCell((StructuredWP)en);
			
			if (en.getClass().equals(ingenias.editor.entities.DPDFSMMat.class)) 
				return  new ingenias.editor.cell.DPDFSMMatCell((DPDFSMMat)en);
			
			if (en.getClass().equals(ingenias.editor.entities.DPDFSMMel.class)) 
				return  new ingenias.editor.cell.DPDFSMMelCell((DPDFSMMel)en);
			
			if (en.getClass().equals(ingenias.editor.entities.DPDFSMMop.class)) 
			...
			if (en.getClass().equals(ingenias.editor.entities.Phase.class))
				return  new ingenias.editor.cell.PhaseCell((Phase)en);
			
			if (en.getClass().equals(ingenias.editor.entities.iPhase.class))
				return  new ingenias.editor.cell.iPhaseCell((iPhase)en);
			
			if (en.getClass().equals(ingenias.editor.entities.Activity.class))
