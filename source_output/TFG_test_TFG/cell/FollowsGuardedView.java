...
public class FollowsGuardedView extends NAryView {

static FollowsGuardedRenderer renderer1 = new FollowsGuardedRenderer();

  // Constructor.
  public FollowsGuardedView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.FollowsGuarded ent=(ingenias.editor.entities.FollowsGuarded)((DefaultGraphCell)this.getCell()).getUserObject();
