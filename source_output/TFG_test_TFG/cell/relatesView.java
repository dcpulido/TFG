...
public class relatesView extends NAryView {

static relatesRenderer renderer1 = new relatesRenderer();

  // Constructor.
  public relatesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.relates ent=(ingenias.editor.entities.relates)((DefaultGraphCell)this.getCell()).getUserObject();
