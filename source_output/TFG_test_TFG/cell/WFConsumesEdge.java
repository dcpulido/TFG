...
this.addClass("WFConsumessource","ingenias.editor.entities.MentalState");
     
    
     this.addRole("WFConsumestarget");
     this.setArity("WFConsumestarget",true,1);
     this.setArity("WFConsumestarget",false,2147483647);
     
this.addClass("WFConsumestarget","ingenias.editor.entities.MentalEntity");
     
this.addClass("WFConsumestarget","ingenias.editor.entities.MentalInstanceSpecification");
