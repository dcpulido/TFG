...
public class ActivityWPDiagramModelJGraph extends ModelJGraph {
  ...
  public JToolBar getPaleta() {
   ...
   protected void creaToolBar() {
        if (toolbar==null){
            toolbar = new FilteredJToolBar("ActivityWPDiagram");
...
if (entity.equalsIgnoreCase("AgentWS")) {
            AgentWS nentity=getOM().$createname(getMJGraph().getNewId("AgentWS"));
        ...
        if (entity.equalsIgnoreCase("TaskWS")) {
            TaskWS nentity=getOM().$createname(getMJGraph().getNewId("TaskWS"));
            DefaultGraphCell vertex = new
            TaskWSCell(nentity);
            // Default Size for the cell with the new entity
            return vertex;
        ...
        if (entity.equalsIgnoreCase("WorkProduct")) {
            WorkProduct nentity=getOM().$createname(getMJGraph().getNewId("WorkProduct"));
            DefaultGraphCell vertex = new
        ...
        if (entity.equalsIgnoreCase("RoleWS")) {
            RoleWS nentity=getOM().$createname(getMJGraph().getNewId("RoleWS"));
            DefaultGraphCell vertex = new
            RoleWSCell(nentity);
            // Default Size for the cell with the new entity
            return vertex;
        ...
        if (entity.equalsIgnoreCase("BehaviourWP")) {
            BehaviourWP nentity=getOM().$createname(getMJGraph().getNewId("BehaviourWP"));
            DefaultGraphCell vertex = new
