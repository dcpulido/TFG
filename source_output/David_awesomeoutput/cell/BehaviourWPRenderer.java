...
public class BehaviourWPRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("BehaviourWP",
	index,"/ingenias/editor/rendererxml/BehaviourWPUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("BehaviourWP",
	index,"/ingenias/editor/rendererxml/BehaviourWPINGENIASPanel.xml");
     ...
     */
    public BehaviourWPRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("BehaviourWP",current);
    }
  ...
  public static void setEntity(BehaviourWP ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("BehaviourWP",ent.getPrefs().getView());
	...
	{
	return RenderComponentManager.retrievePanel("BehaviourWP",
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("BehaviourWP",current);
	}
