...
public class DPDFPrecedesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("DPDFPrecedes",
	index,"/ingenias/editor/rendererxml/DPDFPrecedesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("DPDFPrecedes",
	index,"/ingenias/editor/rendererxml/DPDFPrecedesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("DPDFPrecedes",
	index,"/ingenias/editor/rendererxml/DPDFPrecedesLABELPanel.xml");
     ...
     */
     public DPDFPrecedesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("DPDFPrecedes",current);
    }
 ...
 public static void setEntity(DPDFPrecedes ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("DPDFPrecedes",ent.getPrefs().getView());
	...
	{
	return RenderComponentManager.retrievePanel("DPDFPrecedes",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("DPDFPrecedes",c);
	}
