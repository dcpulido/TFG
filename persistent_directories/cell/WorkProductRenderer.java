...
public class WorkProductRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("WorkProduct",
	index,"/ingenias/editor/rendererxml/WorkProductUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WorkProduct",
	index,"/ingenias/editor/rendererxml/WorkProductINGENIASPanel.xml");
     ...
     */
    public WorkProductRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("WorkProduct",current);
    }
  ...
  public static void setEntity(WorkProduct ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WorkProduct",ent.getPrefs().getView());
	...
	{
	return RenderComponentManager.retrievePanel("WorkProduct",
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("WorkProduct",current);
	}
