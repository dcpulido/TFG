...
public class WFConsumesEdge extends NAryEdge {
	
	// Constructor with data content
	public WFConsumesEdge(WFConsumes userObject) {
		super(userObject);
		
		this.addRole("WFConsumessource");
		this.setArity("WFConsumessource",true,1);
		this.setArity("WFConsumessource",false,1);
		
		this.addClass("WFConsumessource","ingenias.editor.entities.Task");
		
		this.addClass("WFConsumessource","ingenias.editor.entities.TaskWS");
		
		//this.addClass("WFConsumessource","ingenias.editor.entities.WorkProduct");
		
		
		this.addRole("WFConsumestarget");
		this.setArity("WFConsumestarget",true,1);
		this.setArity("WFConsumestarget",false,1);
		
		//this.addClass("WFConsumestarget","ingenias.editor.entities.MentalEntity");
		
		//this.addClass("WFConsumessource","ingenias.editor.entities.Task");
		
		//this.addClass("WFConsumessource","ingenias.editor.entities.TaskWS");
		
		this.addClass("WFConsumestarget","ingenias.editor.entities.Resource");
		
		this.addClass("WFConsumestarget","ingenias.editor.entities.WorkProduct");
		
		this.addClass("WFConsumestarget","ingenias.editor.entities.FreeWP");
		
		this.addClass("WFConsumestarget","ingenias.editor.entities.StructuralWP");
		
		this.addClass("WFConsumestarget","ingenias.editor.entities.StructuredWP");
		
		this.addClass("WFConsumestarget","ingenias.editor.entities.BehaviourWP");
	...
	public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
		...
		if (nAryEdgesNum > 1 || edgesNum > 0 ||
			!((selectedEdge == null) || (selectedEdge instanceof WFConsumesEdge)))
			return false;
		
		// n-edge to be considered.
		WFConsumesEdge edge = new WFConsumesEdge( null);
		...
		if (nAryEdgesNum == 1 && selectedEdge instanceof WFConsumesEdge)
			edge = (WFConsumesEdge) selectedEdge;
