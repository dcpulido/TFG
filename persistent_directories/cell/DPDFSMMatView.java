...
public class DPDFSMMatView extends VertexView {

  public static DPDFSMMatRenderer renderer = new DPDFSMMatRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public DPDFSMMatView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.DPDFSMMat ent=(ingenias.editor.entities.DPDFSMMat)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(DPDFSMMat ent) {
