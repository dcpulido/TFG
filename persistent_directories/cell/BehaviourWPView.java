...
public class BehaviourWPView extends VertexView {

  public static BehaviourWPRenderer renderer = new BehaviourWPRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public BehaviourWPView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.BehaviourWP ent=(ingenias.editor.entities.BehaviourWP)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(BehaviourWP ent) {
