...
public class DPDFPrecedesEdge extends NAryEdge {
	
	// Constructor with data content
	public DPDFPrecedesEdge(DPDFPrecedes userObject) {
		super(userObject);
		
		this.addRole("DPDFPrecedessource");
		this.setArity("DPDFPrecedessource",true,1);
		this.setArity("DPDFPrecedessource",false,1);
		
		this.addClass("DPDFPrecedessource","ingenias.editor.entities.InitialNode");
		this.addClass("DPDFPrecedessource","ingenias.editor.entities.EndNode");
		this.addClass("DPDFPrecedessource","ingenias.editor.entities.Phase");
		this.addClass("DPDFPrecedessource","ingenias.editor.entities.iPhase");
		this.addClass("DPDFPrecedessource","ingenias.editor.entities.Activity");
		this.addClass("DPDFPrecedessource","ingenias.editor.entities.TaskWS");
		this.addClass("DPDFPrecedessource","ingenias.editor.entities.ForkNode");
		this.addClass("DPDFPrecedessource","ingenias.editor.entities.JoinNode");
		this.addClass("DPDFPrecedessource","ingenias.editor.entities.DecisionNode");
		
		this.addRole("DPDFPrecedestarget");
		this.setArity("DPDFPrecedestarget",true,1);
		this.setArity("DPDFPrecedestarget",false,1);
		
		this.addClass("DPDFPrecedestarget","ingenias.editor.entities.InitialNode");
		this.addClass("DPDFPrecedestarget","ingenias.editor.entities.EndNode");
		this.addClass("DPDFPrecedestarget","ingenias.editor.entities.Phase");
		this.addClass("DPDFPrecedestarget","ingenias.editor.entities.iPhase");
		this.addClass("DPDFPrecedestarget","ingenias.editor.entities.Activity");
		this.addClass("DPDFPrecedestarget","ingenias.editor.entities.TaskWS");
		this.addClass("DPDFPrecedestarget","ingenias.editor.entities.JoinNode");
		this.addClass("DPDFPrecedestarget","ingenias.editor.entities.DecisionNode");
		this.addClass("DPDFPrecedestarget","ingenias.editor.entities.ForkNode");
	...
	public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
		...
		if (nAryEdgesNum > 1 || edgesNum > 0 ||
			!((selectedEdge == null) || (selectedEdge instanceof DPDFPrecedesEdge)))
			return false;
		
		// n-edge to be considered.
		DPDFPrecedesEdge edge = new DPDFPrecedesEdge( null);
		...
		if (nAryEdgesNum == 1 && selectedEdge instanceof DPDFPrecedesEdge)
			edge = (DPDFPrecedesEdge) selectedEdge;
	...
	public DefaultEdge[] connectionsEdges(GraphCell[] selected, String[] roles) {
		...
		for (int i = 0; i < selected.length; i++)
			if ( ! (selected[i] instanceof DefaultEdge ||
				...
				if (roles[i].equalsIgnoreCase("DPDFPrecedessource")){
					edges.add( new DefaultEdge( new DPDFPrecedessourceRole() ) );
				}
				
				if (roles[i].equalsIgnoreCase("DPDFPrecedestarget")){
					edges.add( new DefaultEdge( new DPDFPrecedestargetRole() ) );
				}
