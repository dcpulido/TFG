...
public class PhaseView extends VertexView {

  public static PhaseRenderer renderer = new PhaseRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public PhaseView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.Phase ent=(ingenias.editor.entities.Phase)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(Phase ent) {
