...
public class WFContainsView extends NAryView {
	
	static WFContainsRenderer renderer1 = new WFContainsRenderer();
	
	// Constructor.
	public WFContainsView(Object cell) {
		super(cell);
	}
	...
	public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
		...
		try {
			ingenias.editor.entities.WFContains ent=(ingenias.editor.entities.WFContains)((DefaultGraphCell)this.getCell()).getUserObject();
