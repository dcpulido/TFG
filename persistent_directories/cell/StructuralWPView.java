...
public class StructuralWPView extends VertexView {

  public static StructuralWPRenderer renderer = new StructuralWPRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public StructuralWPView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.StructuralWP ent=(ingenias.editor.entities.StructuralWP)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(StructuralWP ent) {
