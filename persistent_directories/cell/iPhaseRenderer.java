...
public class iPhaseRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("iPhase",
	index,"/ingenias/editor/rendererxml/iPhaseUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("iPhase",
	index,"/ingenias/editor/rendererxml/iPhaseINGENIASPanel.xml");
     ...
     */
    public iPhaseRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("iPhase",current);
    }
  ...
  public static void setEntity(iPhase ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("iPhase",ent.getPrefs().getView());
	...
	{
	return RenderComponentManager.retrievePanel("iPhase",
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("iPhase",current);
	}
