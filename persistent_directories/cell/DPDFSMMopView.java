...
public class DPDFSMMopView extends VertexView {

  public static DPDFSMMopRenderer renderer = new DPDFSMMopRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public DPDFSMMopView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.DPDFSMMop ent=(ingenias.editor.entities.DPDFSMMop)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(DPDFSMMop ent) {
