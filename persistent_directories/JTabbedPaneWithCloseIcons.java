...
public class JTabbedPaneWithCloseIcons extends JTabbedPane {
	...
	public static void main(String args[]){
		JTabbedPaneWithCloseIcons jtb=new JTabbedPaneWithCloseIcons();
		jtb.setTabLayoutPolicy(JTabbedPane.SCROLL_TAB_LAYOUT);
		jtb.setUI(new PSTabbedPaneUI());
		JFrame jf=new JFrame();
		jf.getContentPane().add(jtb);
		jtb.addTab("uno",ProjectTreeRenderer.selectIconByUserObject(new Agent("hola")), new JLabel("hola"));
		jtb.addTab("dos", new JLabel("adios"));
		jtb.addTab("tres", new JLabel("adios"));
		jf.pack();
		jf.setVisible(true);
	}
}