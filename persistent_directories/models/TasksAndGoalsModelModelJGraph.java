...
public class TasksAndGoalsModelModelJGraph extends ModelJGraph {
  ...
  protected void creaToolBar() {
    ...
    Image img_Agent =
        ImageLoader.getImage("images/agent40.gif");
    ...
    Image img_Resource =
        ImageLoader.getImage("images/resource40.jpg");
    ...
    Image img_RoleWS =
        ImageLoader.getImage("images/dpdfroleWS40.gif");
    ...
    Image img_ApplicationWS =
        ImageLoader.getImage("images/app40.jpg");
 ...
 entities.add("Interaction");
  ...
  public DefaultGraphCell createCell(String entity) throws InvalidEntity{
    ...
    Task nentity=getOM().createTask(getMJGraph().getNewId("Action"));
      DefaultGraphCell vertex = new
          TaskCell(nentity);
      // Default Size for the cell with the new entity
     return vertex;
