...
public class DeployDiagramModelJGraph extends ModelJGraph {
  ...
  protected void creaToolBar() {
    ...
    Image img_TestingPackage =
        ImageLoader.getImage("images/test40.gif");
    ...
    Image img_DeploymentPackage =
        ImageLoader.getImage("images/depl40.gif");
    ...
    Image img_INGENIASComponent =
        ImageLoader.getImage("images/icomponent40.gif");
    ...
    Image img_DeploymentUnitByType =
        ImageLoader.getImage("images/typedepl40.gif");
    ...
    Image img_DeploymentUnitByTypeEnumInitMS =
        ImageLoader.getImage("images/imtypedepl40.gif");
