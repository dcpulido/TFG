...
public class ObjectManager extends javax.swing.tree.DefaultMutableTreeNode implements java.io.Serializable {
    ...
    public javax.swing.tree.DefaultMutableTreeNode InteractionSpecNode=null;
    ...
    public javax.swing.tree.DefaultMutableTreeNode WorkProductNode=null;
    
    public javax.swing.tree.DefaultMutableTreeNode FreeWPNode=null;
    
    public javax.swing.tree.DefaultMutableTreeNode StructuralWPNode=null;
    
    public javax.swing.tree.DefaultMutableTreeNode StructuredWPNode=null;
    
    public javax.swing.tree.DefaultMutableTreeNode BehaviourWPNode=null;
    
    public javax.swing.tree.DefaultMutableTreeNode PhaseNode=null;
    
    public javax.swing.tree.DefaultMutableTreeNode iPhaseNode=null;
    
    public javax.swing.tree.DefaultMutableTreeNode ActivityNode=null;
    
    public javax.swing.tree.DefaultMutableTreeNode UMLObjectNode=null;
    
    public javax.swing.tree.DefaultMutableTreeNode DPDFSMMatNode=null;
    
    public javax.swing.tree.DefaultMutableTreeNode DPDFSMMelNode=null;
    
    public javax.swing.tree.DefaultMutableTreeNode DPDFSMMopNode=null;
    ...
    private ObjectManager(javax.swing.tree.DefaultMutableTreeNode root,JTree arbolObjetos) {
        ...
        InternalApplicationNode=new javax.swing.tree.DefaultMutableTreeNode("InternalApp");
        ...
        GoalNode=new javax.swing.tree.DefaultMutableTreeNode("GoalEntities");
        ...
        MentalEntityNode=new javax.swing.tree.DefaultMutableTreeNode("MentalStateEntities");
        ...
        UseCaseNode=new javax.swing.tree.DefaultMutableTreeNode("UseCaseEntities");
        ...
        INGENIASObjectNode=new javax.swing.tree.DefaultMutableTreeNode("MetaElements");
        ...
        OrganizationNode=new javax.swing.tree.DefaultMutableTreeNode("OrganizationEntities");
        ...
        AUMLSpecificationNode=new javax.swing.tree.DefaultMutableTreeNode("AUMLInteractionSpecification");
        
        ApplicationNode=new javax.swing.tree.DefaultMutableTreeNode("Application");
        
        DeploymentPackageNode=new javax.swing.tree.DefaultMutableTreeNode("Deployment");
        
        PlanNode=new javax.swing.tree.DefaultMutableTreeNode("Plan");
        
        UMLComponentNode=new javax.swing.tree.DefaultMutableTreeNode("Codification");
        ...
        OrganizationGroupNode=new javax.swing.tree.DefaultMutableTreeNode("Group");
        ...
        UMLCommentNode=new javax.swing.tree.DefaultMutableTreeNode("Comment");
        
        AgentRequirementsQueryNode=new javax.swing.tree.DefaultMutableTreeNode("AgentRequirements");
        
        UMLSpecificationNode=new javax.swing.tree.DefaultMutableTreeNode("UMLInteractionSpecification");
        ...
        Autonomous_entityNode=new javax.swing.tree.DefaultMutableTreeNode("AgentEntities");
        ...
        EnvironmentApplicationNode=new javax.swing.tree.DefaultMutableTreeNode("EnvironmentApp");
        ...
        InteractionUnitNode=new javax.swing.tree.DefaultMutableTreeNode("InteractionEntities");
        
        GRASIASpecificationNode=new javax.swing.tree.DefaultMutableTreeNode("GRASIAInteractionSpecification");
        ...
        //New
        InteractionSpecNode=new javax.swing.tree.DefaultMutableTreeNode("InteractionSpecification");
        ...
        INGENIASCodeComponentNode=new javax.swing.tree.DefaultMutableTreeNode("CodeComponent");
        ...
        TaskNode=new javax.swing.tree.DefaultMutableTreeNode("TaskEntities");
        ...
        WorkProductNode=new javax.swing.tree.DefaultMutableTreeNode("WorkProduct");
        
        FreeWPNode=new javax.swing.tree.DefaultMutableTreeNode("FreeWP");
        
        BehaviourWPNode=new javax.swing.tree.DefaultMutableTreeNode("BehaviourWP");
        
        StructuralWPNode=new javax.swing.tree.DefaultMutableTreeNode("StructuralWP");
        
        StructuredWPNode=new javax.swing.tree.DefaultMutableTreeNode("StructuredWP");
		
		DPDFSMMatNode=new javax.swing.tree.DefaultMutableTreeNode("DPDFSMMat");
		
		DPDFSMMelNode=new javax.swing.tree.DefaultMutableTreeNode("DPDFSMMel");
		
		DPDFSMMopNode=new javax.swing.tree.DefaultMutableTreeNode("DPDFSMMop");
        
        PhaseNode=new javax.swing.tree.DefaultMutableTreeNode("Phase");
        
        iPhaseNode=new javax.swing.tree.DefaultMutableTreeNode("iPhase");
        
        ActivityNode=new javax.swing.tree.DefaultMutableTreeNode("Activity");
        ...
        //addNodeInSortedOrder( INGENIASObjectNode,UMLClassifierNode);
        
        //addNodeInSortedOrder( root,UMLObjectNode);
        
        //New
        addNodeInSortedOrder( SpecificationNode,InteractionSpecNode);
        // 2nd and lower nodes
        ...
        addNodeInSortedOrder( DeploymentPackageNode,TestingPackageNode);
        
        //addNodeInSortedOrder( INGENIASObjectNode,MethodParameterNode);
        addNodeInSortedOrder( ApplicationNode,MethodParameterNode);
        
        //addNodeInSortedOrder( INGENIASObjectNode,MentalStateNode);
        addNodeInSortedOrder( AgentComponentNode,MentalStateNode);
        
        addNodeInSortedOrder( ApplicationNode,InternalApplicationNode);
        
        addNodeInSortedOrder( UMLComponentNode,FileSpecMappingNode);
        //addNodeInSortedOrder( INGENIASObjectNode,FileSpecMappingNode);
        
        //addNodeInSortedOrder( ControlMentalEntityNode,GoalNode);
        addNodeInSortedOrder( INGENIASObjectNode,GoalNode);
        ...
        addNodeInSortedOrder( SpecificationNode,TextNoteNode);
        ...
        addNodeInSortedOrder( SpecificationNode,UseCaseNode);
        ...
        addNodeInSortedOrder( AgentRequirementsQueryNode,SlotValueSpecificationNode);
		...
		addNodeInSortedOrder( OrganizationNode,OrganizationGroupNode);
        ...
        addNodeInSortedOrder( DeploymentPackageNode,DeploymentUnitByTypeNode);
        ...
        //addNodeInSortedOrder( AgentNode,AutonomousEntityQueryNode);
        
        addNodeInSortedOrder( AUMLComponentNode,AUMLContainerNode);
        
        //addNodeInSortedOrder( AutonomousEntityQueryNode,ConcreteAgentNode);
        //addNodeInSortedOrder( AgentNode,ConcreteAgentNode);
        
        //addNodeInSortedOrder( UMLObjectNode,UMLCommentNode);
        addNodeInSortedOrder( SpecificationNode,UMLCommentNode);
        
        //addNodeInSortedOrder( AutonomousEntityQueryNode,AgentRequirementsQueryNode);
        addNodeInSortedOrder( SpecificationNode,AgentRequirementsQueryNode);
		
        addNodeInSortedOrder( InteractionSpecNode,UMLSpecificationNode);
        
        addNodeInSortedOrder( InformationMentalEntityNode,BelieveNode);
        
        //addNodeInSortedOrder( WorkflowNode,WorkflowBoxNode);
        addNodeInSortedOrder( iPhaseNode,PhaseNode);
		
        addNodeInSortedOrder( iPhaseNode,PhaseNode);
		
        addNodeInSortedOrder( INGENIASObjectNode,iPhaseNode);
        
        addNodeInSortedOrder( INGENIASObjectNode,ActivityNode);
        
        //addNodeInSortedOrder( UMLObjectNode,DecisionNodeNode);
		addNodeInSortedOrder( ActivityNode,DecisionNodeNode);
        
        addNodeInSortedOrder( ActivityNode,InitialNodeNode);
        
        addNodeInSortedOrder( ActivityNode,MergeNodeNode);
        
        addNodeInSortedOrder( ActivityNode,JoinNodeNode);
        
        addNodeInSortedOrder( ActivityNode,ForkNodeNode);
        
        addNodeInSortedOrder( ActivityNode,EndNodeNode);
        
        //addNodeInSortedOrder( INGENIASObjectNode,AgentComponentNode);
        addNodeInSortedOrder( AgentNode,AgentComponentNode);
        ...
        addNodeInSortedOrder( Autonomous_entityNode,RoleNode);
        ...
        addNodeInSortedOrder( AgentRequirementsQueryNode,AgentDescriptionNode);
        
        //addNodeInSortedOrder( INGENIASObjectNode,MentalStatePatternNode);
        addNodeInSortedOrder( MentalStateNode,MentalStatePatternNode);
        ...
        addNodeInSortedOrder( AgentRequirementsQueryNode,MentalInstanceSpecificationNode);
        ...
        addNodeInSortedOrder( INGENIASObjectNode,TaskNode);
        ...
        addNodeInSortedOrder( ResourceNode,WorkProductNode);
        
        addNodeInSortedOrder( WorkProductNode,FreeWPNode);
        
        addNodeInSortedOrder( WorkProductNode,StructuralWPNode);
        
        addNodeInSortedOrder( WorkProductNode,StructuredWPNode);
        
        addNodeInSortedOrder( WorkProductNode,BehaviourWPNode);
        
        addNodeInSortedOrder( FrameFactNode,DPDFSMMatNode);
		
        addNodeInSortedOrder( FrameFactNode,DPDFSMMelNode);
		
        addNodeInSortedOrder( FrameFactNode,DPDFSMMopNode);
        ...
        addNodeInSortedOrder( TaskNode,WorkflowNode);
    ...
    public Phase createPhase(String id){
        Phase object=new     Phase(id);
        DefaultMutableTreeNode nn=new DefaultMutableTreeNode(object);
        PhaseNode.insert(nn, PhaseNode.getChildCount());
        nn.setParent(PhaseNode);
        this.reload();
        arbolObjetos.repaint();
        return object;
    }
    
    public Object getPhase(String object){
        Object o=findUserObject(PhaseNode,object);
        return o;
    }
    
    public iPhase createiPhase(String id){
        iPhase object=new     iPhase(id);
        DefaultMutableTreeNode nn=new DefaultMutableTreeNode(object);
        iPhaseNode.insert(nn, iPhaseNode.getChildCount());
        nn.setParent(iPhaseNode);
        this.reload();
        arbolObjetos.repaint();
        return object;
    }
    
    public Object getiPhase(String object){
        Object o=findUserObject(iPhaseNode,object);
        return o;
    }
    
    public Activity createActivity(String id){
        Activity object=new     Activity(id);
        DefaultMutableTreeNode nn=new DefaultMutableTreeNode(object);
        ActivityNode.insert(nn, ActivityNode.getChildCount());
        nn.setParent(ActivityNode);
        this.reload();
        arbolObjetos.repaint();
        return object;
    }
    
    public Object getActivity(String object){
        Object o=findUserObject(ActivityNode,object);
        return o;
    }
    ...
    public WorkProduct createWorkProduct(String id){
        WorkProduct object = new WorkProduct(id);
        DefaultMutableTreeNode nn=new DefaultMutableTreeNode(object);
        WorkProductNode.insert(nn, WorkProductNode.getChildCount());
        nn.setParent(WorkProductNode);
        this.reload();
        arbolObjetos.repaint();
        return object;
    }
    
    public Object getWorkProduct(String object){
        Object o=findUserObject(WorkProductNode,object);
        return o;
    }
    
    public FreeWP createFreeWP(String id){
        FreeWP object = new FreeWP(id);
        DefaultMutableTreeNode nn=new DefaultMutableTreeNode(object);
        FreeWPNode.insert(nn, FreeWPNode.getChildCount());
        nn.setParent(FreeWPNode);
        this.reload();
        arbolObjetos.repaint();
        return object;
    }
    
    public Object getFreeWP(String object){
        Object o=findUserObject(FreeWPNode,object);
        return o;
    }
    
    public StructuralWP createStructuralWP(String id){
        StructuralWP object = new StructuralWP(id);
        DefaultMutableTreeNode nn=new DefaultMutableTreeNode(object);
        StructuralWPNode.insert(nn, StructuralWPNode.getChildCount());
        nn.setParent(StructuralWPNode);
        this.reload();
        arbolObjetos.repaint();
        return object;
    }
    
    public Object getStructuralWP(String object){
        Object o=findUserObject(StructuralWPNode,object);
        return o;
    }
    
    public StructuredWP createStructuredWP(String id){
        StructuredWP object = new StructuredWP(id);
        DefaultMutableTreeNode nn=new DefaultMutableTreeNode(object);
        StructuredWPNode.insert(nn, StructuredWPNode.getChildCount());
        nn.setParent(StructuredWPNode);
        this.reload();
        arbolObjetos.repaint();
        return object;
    }
    
    public Object getStructuredWP(String object){
        Object o=findUserObject(StructuredWPNode,object);
        return o;
    }
    
    public BehaviourWP createBehaviourWP(String id){
        BehaviourWP object = new BehaviourWP(id);
        DefaultMutableTreeNode nn=new DefaultMutableTreeNode(object);
        BehaviourWPNode.insert(nn, BehaviourWPNode.getChildCount());
        nn.setParent(BehaviourWPNode);
        this.reload();
        arbolObjetos.repaint();
        return object;
    }
    
    public Object getBehaviourWP(String object){
        Object o=findUserObject(BehaviourWPNode,object);
        return o;
    }
    
    public DPDFSMMat createDPDFSMMat(String id){
        DPDFSMMat object=new DPDFSMMat(id);
        DefaultMutableTreeNode nn=new DefaultMutableTreeNode(object);
        DPDFSMMatNode.insert(nn, DPDFSMMatNode.getChildCount());
        nn.setParent(DPDFSMMatNode);
        this.reload();
        arbolObjetos.repaint();
        return object;
    }
    
    public Object getDPDFSMMat(String object){
        Object o=findUserObject(DPDFSMMatNode,object);
        return o;
    }
    
    public DPDFSMMel createDPDFSMMel(String id){
        DPDFSMMel object=new     DPDFSMMel(id);
        DefaultMutableTreeNode nn=new DefaultMutableTreeNode(object);
        DPDFSMMelNode.insert(nn, DPDFSMMelNode.getChildCount());
        nn.setParent(DPDFSMMelNode);
        this.reload();
        arbolObjetos.repaint();
        return object;
    }
    
    public Object getDPDFSMMel(String object){
        Object o=findUserObject(DPDFSMMelNode,object);
        return o;
    }
    
    public DPDFSMMop createDPDFSMMop(String id){
        DPDFSMMop object=new     DPDFSMMop(id);
        DefaultMutableTreeNode nn=new DefaultMutableTreeNode(object);
        DPDFSMMopNode.insert(nn, DPDFSMMopNode.getChildCount());
        nn.setParent(DPDFSMMopNode);
        this.reload();
        arbolObjetos.repaint();
        return object;
    }
    
    public Object getDPDFSMMop(String object){
        Object o=findUserObject(DPDFSMMopNode,object);
        return o;
    }
    ...
    public static Vector getValidEntitiesClasses(){
        ...
        result.add(WorkProduct.class);
        
        result.add(BehaviourWP.class);
        
        result.add(FreeWP.class);
        
        result.add(StructuralWP.class);
        
        result.add(StructuredWP.class);
        
        result.add(AUMLAlternativeBox.class);
        
        result.add(Workflow.class);
        
        result.add(Phase.class);
        
        result.add(iPhase.class);
        
        result.add(Activity.class);
		
		result.add(DPDFSMMat.class);
		
		result.add(DPDFSMMel.class);
		
		result.add(DPDFSMMop.class);
        ...
        result.add(RoleDiagramModelEntity.class);
    ...
    private Object findUserObjectInTree(DefaultMutableTreeNode dtn, String name, String type){
        ...
        while (node!=null) {
			...
			//else System.out.println("Find User.- " + name + " no existe en el árbol con el tipo: " + type);
            node = node.getNextLeaf();
        }
        return null;
    }
    ...
    public DefaultMutableTreeNode findNodeInTree(DefaultMutableTreeNode dtn, String name, String type){
        ...
        while (node!=null) {
			...
			//else System.out.println("Find Node.- " + name + " no existe en el árbol con el tipo: " + type);
            node = node.getNextLeaf();
        }
        return null;
    }
