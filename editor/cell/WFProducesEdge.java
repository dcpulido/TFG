...
public class WFProducesEdge extends NAryEdge {
	
	// Constructor with data content
	public WFProducesEdge(WFProduces userObject) {
		super(userObject);
		
		this.addRole("WFProducessource");
		this.setArity("WFProducessource",true,1);
		this.setArity("WFProducessource",false,1);
		
		this.addClass("WFProducessource","ingenias.editor.entities.Task");
		
		this.addClass("WFProducessource","ingenias.editor.entities.TaskWS");
		
		//this.addClass("WFProducessource","ingenias.editor.entities.WorkProduct");
		
		
		this.addRole("WFProducestarget");
		this.setArity("WFProducestarget",true,1);
		this.setArity("WFProducestarget",false,1);
		
		//this.addClass("WFProducestarget","ingenias.editor.entities.MentalEntity");
		
		this.addClass("WFProducestarget","ingenias.editor.entities.Resource");
		
		this.addClass("WFProducestarget","ingenias.editor.entities.WorkProduct");
		
		this.addClass("WFProducestarget","ingenias.editor.entities.FreeWP");
		
		this.addClass("WFProducestarget","ingenias.editor.entities.StructuralWP");
		
		this.addClass("WFProducestarget","ingenias.editor.entities.StructuredWP");
		
		this.addClass("WFProducestarget","ingenias.editor.entities.BehaviourWP");
		
		//this.addClass("WFProducestarget","ingenias.editor.entities.TaskWS");
	...
	public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
		...
		if (nAryEdgesNum > 1 || edgesNum > 0 ||
			!((selectedEdge == null) || (selectedEdge instanceof WFProducesEdge)))
			return false;
		
		// n-edge to be considered.
		WFProducesEdge edge = new WFProducesEdge( null);
		...
		if (nAryEdgesNum == 1 && selectedEdge instanceof WFProducesEdge)
			edge = (WFProducesEdge) selectedEdge;
