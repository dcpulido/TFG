...
public class WFResponsableEdge extends NAryEdge {
	
	// Constructor with data content
	public WFResponsableEdge(WFResponsable userObject) {
		super(userObject);
		
		this.addRole("WFResponsablesource");
		this.setArity("WFResponsablesource",true,1);
		this.setArity("WFResponsablesource",false,1);
		
		this.addClass("WFResponsablesource","ingenias.editor.entities.Agent");
		
		this.addClass("WFResponsablesource","ingenias.editor.entities.Role");
		
		this.addClass("WFResponsablesource","ingenias.editor.entities.RoleWS");
		
		this.addClass("WFResponsablesource","ingenias.editor.entities.AutonomousEntityQuery");
		
		
		this.addRole("WFResponsabletarget");
		this.setArity("WFResponsabletarget",true,1);
		this.setArity("WFResponsabletarget",false,2147483647);
		
		this.addClass("WFResponsabletarget","ingenias.editor.entities.Task");

		this.addClass("WFResponsabletarget","ingenias.editor.entities.TaskWS");
	...
	public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
		...
		if (nAryEdgesNum > 1 || edgesNum > 0 ||
			!((selectedEdge == null) || (selectedEdge instanceof WFResponsableEdge)))
			return false;
		
		// n-edge to be considered.
		WFResponsableEdge edge = new WFResponsableEdge( null);
		...
		if (nAryEdgesNum == 1 && selectedEdge instanceof WFResponsableEdge)
			edge = (WFResponsableEdge) selectedEdge;
