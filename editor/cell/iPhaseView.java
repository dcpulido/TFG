...
public class iPhaseView extends VertexView {

  public static iPhaseRenderer renderer = new iPhaseRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public iPhaseView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.iPhase ent=(ingenias.editor.entities.iPhase)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(iPhase ent) {
