...
public class ActivityView extends VertexView {
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.Activity ent=(ingenias.editor.entities.Activity)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(Activity ent) {
