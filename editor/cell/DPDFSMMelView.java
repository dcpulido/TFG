...
public class DPDFSMMelView extends VertexView {

  public static DPDFSMMelRenderer renderer = new DPDFSMMelRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public DPDFSMMelView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.DPDFSMMel ent=(ingenias.editor.entities.DPDFSMMel)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(DPDFSMMel ent) {
