...
public class ActivityPrecedesView extends NAryView {
	
	static ActivityPrecedesRenderer renderer1 = new ActivityPrecedesRenderer();
	
	// Constructor.
	public ActivityPrecedesView(Object cell) {
		super(cell);
	}
	...
	public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
		...
		try {
			ingenias.editor.entities.ActivityPrecedes ent=(ingenias.editor.entities.ActivityPrecedes)((DefaultGraphCell)this.getCell()).getUserObject();
