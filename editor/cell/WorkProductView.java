...
public class WorkProductView extends VertexView {

  public static WorkProductRenderer renderer = new WorkProductRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public WorkProductView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.WorkProduct ent=(ingenias.editor.entities.WorkProduct)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(WorkProduct ent) {
