...
public class FreeWPView extends VertexView {
	
	public static FreeWPRenderer renderer = new FreeWPRenderer();
	
	// Constructor for Superclass
	// cell es un AgentCell
	public FreeWPView(Object cell) {
		super(cell);
	}
	...
	public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
		...
		try {
			ingenias.editor.entities.FreeWP ent=(ingenias.editor.entities.FreeWP)((DefaultGraphCell)this.getCell()).getUserObject();
	...
	static public Dimension getSize(FreeWP ent) {
