...
public class StructuredWPView extends VertexView {

  public static StructuredWPRenderer renderer = new StructuredWPRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public StructuredWPView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.StructuredWP ent=(ingenias.editor.entities.StructuredWP)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(StructuredWP ent) {
