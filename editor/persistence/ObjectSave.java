...
public class ObjectSave extends ObjectSaveAbs{
	...
	IOException {
		...
		if (en.getClass().equals(ingenias.editor.entities.PhaseDiagramDataEntity.class)){
			ingenias.editor.entities.PhaseDiagramDataEntity nen=(ingenias.editor.entities.PhaseDiagramDataEntity)en;
			String _name;
			
			
        }
        
		if (en.getClass().equals(ingenias.editor.entities.RoleDiagramDataEntity.class)){
			ingenias.editor.entities.RoleDiagramDataEntity nen=(ingenias.editor.entities.RoleDiagramDataEntity)en;
			String _name;
		...
		if (en.getClass().equals(ingenias.editor.entities.DPDFPrecedes.class)){
			ingenias.editor.entities.DPDFPrecedes nen=(ingenias.editor.entities.DPDFPrecedes)en;
			
			
        }
		
		if (en.getClass().equals(ingenias.editor.entities.ActivityPrecedes.class)){
			ingenias.editor.entities.ActivityPrecedes nen=(ingenias.editor.entities.ActivityPrecedes)en;
		...
		if (en.getClass().equals(ingenias.editor.entities.WFContains.class)){
			ingenias.editor.entities.WFContains nen=(ingenias.editor.entities.WFContains)en;
			
			
        }
        
		if (en.getClass().equals(ingenias.editor.entities.WPContains.class)){
			ingenias.editor.entities.WPContains nen=(ingenias.editor.entities.WPContains)en;
			
			
        }
        
		if (en.getClass().equals(ingenias.editor.entities.WPDepends.class)){
			ingenias.editor.entities.WPDepends nen=(ingenias.editor.entities.WPDepends)en;
		...
		if (en.getClass().equals(ingenias.editor.entities.Refines.class)){
			ingenias.editor.entities.Refines nen=(ingenias.editor.entities.Refines)en;
