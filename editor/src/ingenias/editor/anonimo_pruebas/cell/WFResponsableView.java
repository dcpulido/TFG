...
public class WFResponsableView extends NAryView {

static WFResponsableRenderer renderer1 = new WFResponsableRenderer();

  // Constructor.
  public WFResponsableView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.WFResponsable ent=(ingenias.editor.entities.WFResponsable)((DefaultGraphCell)this.getCell()).getUserObject();
