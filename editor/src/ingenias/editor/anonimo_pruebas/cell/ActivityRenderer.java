...
public class ActivityRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
	...
	static {
		...
		try {
			...
			RenderComponentManager.loadRenderFile("Activity",
												  index,"/ingenias/editor/rendererxml/ActivityUMLPanel.xml");
			
			index=ViewPreferences.ViewType.INGENIAS;
			RenderComponentManager.loadRenderFile("Activity",
												  index,"/ingenias/editor/rendererxml/ActivityINGENIASPanel.xml");
    ...
    public Dimension getSize() {
		return RenderComponentManager.getSize("Activity",current);
    }
	...
	public static void setEntity(Activity ent){
		Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Activity",ent.getPrefs().getView());
	...
	{
		return RenderComponentManager.retrievePanel("Activity",
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("Activity",current);
	}
