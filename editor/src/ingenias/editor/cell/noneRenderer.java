...
public class noneRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("none",
    index,"/ingenias/editor/rendererxml/noneNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("none",
    index,"/ingenias/editor/rendererxml/noneINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("none",
    index,"/ingenias/editor/rendererxml/noneLABELPanel.xml");
    ...
    return RenderComponentManager.getSize("none",current);
    }
 ...
 public static void setEntity(none ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("none",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("none",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("none",c);
    }
