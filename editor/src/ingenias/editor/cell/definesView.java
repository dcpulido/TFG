...
public class definesView extends NAryView {

static definesRenderer renderer1 = new definesRenderer();

  // Constructor.
  public definesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.defines ent=(ingenias.editor.entities.defines)((DefaultGraphCell)this.getCell()).getUserObject();
