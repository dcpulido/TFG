...
public class QDRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("QD",
    index,"/ingenias/editor/rendererxml/QDNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("QD",
    index,"/ingenias/editor/rendererxml/QDINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("QD",
    index,"/ingenias/editor/rendererxml/QDLABELPanel.xml");
    ...
    return RenderComponentManager.getSize("QD",current);
    }
 ...
 public static void setEntity(QD ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("QD",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("QD",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("QD",c);
    }
