...
public class WFConsumesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("WFConsumes",
    index,"/ingenias/editor/rendererxml/WFConsumesNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("WFConsumes",
    index,"/ingenias/editor/rendererxml/WFConsumesINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("WFConsumes",
    index,"/ingenias/editor/rendererxml/WFConsumesLABELPanel.xml");
     ...
     */
     public WFConsumesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("WFConsumes",current);
    }
 ...
 public static void setEntity(WFConsumes ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFConsumes",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("WFConsumes",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("WFConsumes",c);
    }
