...
public class UMLAssociationEdge extends NAryEdge {
    
    // Constructor with data content
    public UMLAssociationEdge(UMLAssociation userObject) {
        super(userObject);
        
        this.addRole("UMLAssociationsource");
        this.setArity("UMLAssociationsource",true,1);
        this.setArity("UMLAssociationsource",false,1);
        
        this.addClass("UMLAssociationsource","ingenias.editor.entities.UseCase");
        this.addClass("UMLAssociationsource","ingenias.editor.entities.DPDFSMMat");
        this.addClass("UMLAssociationsource","ingenias.editor.entities.DPDFSMMel");
        this.addClass("UMLAssociationsource","ingenias.editor.entities.DPDFSMMop");
        
        
        this.addRole("UMLAssociationtarget");
        this.setArity("UMLAssociationtarget",true,1);
        this.setArity("UMLAssociationtarget",false,2147483647);
        
        this.addClass("UMLAssociationtarget","ingenias.editor.entities.UseCase");
        this.addClass("UMLAssociationtarget","ingenias.editor.entities.DPDFSMMat");
        this.addClass("UMLAssociationtarget","ingenias.editor.entities.DPDFSMMel");
        this.addClass("UMLAssociationtarget","ingenias.editor.entities.DPDFSMMop");
    ...
    public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
        ...
        if (nAryEdgesNum > 1 || edgesNum > 0 ||
            !((selectedEdge == null) || (selectedEdge instanceof UMLAssociationEdge)))
            return false;
        
        // n-edge to be considered.
        UMLAssociationEdge edge = new UMLAssociationEdge( null);
        ...
        if (nAryEdgesNum == 1 && selectedEdge instanceof UMLAssociationEdge)
            edge = (UMLAssociationEdge) selectedEdge;
