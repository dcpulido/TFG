...
public class RefinesRenderer extends VertexRenderer implements CellViewRenderer{
	...
	static {
		try {
			...
			RenderComponentManager.loadRenderFile("Refines",
												  index,"/ingenias/editor/rendererxml/RefinesNOICONPanel.xml");
			
			index=ViewPreferences.ViewType.INGENIAS;
			RenderComponentManager.loadRenderFile("Refines",
												  index,"/ingenias/editor/rendererxml/RefinesINGENIASPanel.xml");
			
			index=ViewPreferences.ViewType.LABEL;
			RenderComponentManager.loadRenderFile("Refines",
												  index,"/ingenias/editor/rendererxml/RefinesLABELPanel.xml");
     ...
     */
	public RefinesRenderer() {
    }
	
    public Dimension getSize() {
		return RenderComponentManager.getSize("Refines",current);
    }
	...
	public static void setEntity(Refines ent){
		Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Refines",ent.getPrefs().getView());
	...
	{
		return RenderComponentManager.retrievePanel("Refines",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("Refines",c);
	}
