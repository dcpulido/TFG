...
public class DPDFSMMatRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("DPDFSMMat",
	index,"/ingenias/editor/rendererxml/DPDFSMMatUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("DPDFSMMat",
	index,"/ingenias/editor/rendererxml/DPDFSMMatINGENIASPanel.xml");
     ...
     */
    public DPDFSMMatRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("DPDFSMMat",current);
    }
  ...
  public static void setEntity(DPDFSMMat ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("DPDFSMMat",ent.getPrefs().getView());
	...
	{
	return RenderComponentManager.retrievePanel("DPDFSMMat",
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("DPDFSMMat",current);
	}
