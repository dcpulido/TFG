...
public class RefinesView extends NAryView {

static RefinesRenderer renderer1 = new RefinesRenderer();

  // Constructor.
  public RefinesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.Refines ent=(ingenias.editor.entities.Refines)((DefaultGraphCell)this.getCell()).getUserObject();
