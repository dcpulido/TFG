...
public class WPContainsRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("WPContains",
    index,"/ingenias/editor/rendererxml/WPContainsNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("WPContains",
    index,"/ingenias/editor/rendererxml/WPContainsINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("WPContains",
    index,"/ingenias/editor/rendererxml/WPContainsLABELPanel.xml");
     ...
     */
     public WPContainsRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("WPContains",current);
    }
 ...
 public static void setEntity(WPContains ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WPContains",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("WPContains",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("WPContains",c);
    }
