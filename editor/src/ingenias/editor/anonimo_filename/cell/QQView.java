...
public class QQView extends NAryView {

static QQRenderer renderer1 = new QQRenderer();

  // Constructor.
  public QQView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.QQ ent=(ingenias.editor.entities.QQ)((DefaultGraphCell)this.getCell()).getUserObject();
