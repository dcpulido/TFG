...
public class FollowsGuardedRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("FollowsGuarded",
    index,"/ingenias/editor/rendererxml/FollowsGuardedNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("FollowsGuarded",
    index,"/ingenias/editor/rendererxml/FollowsGuardedINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("FollowsGuarded",
    index,"/ingenias/editor/rendererxml/FollowsGuardedLABELPanel.xml");
     ...
     */
     public FollowsGuardedRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("FollowsGuarded",current);
    }
 ...
 public static void setEntity(FollowsGuarded ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("FollowsGuarded",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("FollowsGuarded",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("FollowsGuarded",c);
    }
