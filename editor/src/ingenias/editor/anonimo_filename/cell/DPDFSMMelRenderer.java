...
public class DPDFSMMelRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("DPDFSMMel",
	index,"/ingenias/editor/rendererxml/DPDFSMMelUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("DPDFSMMel",
	index,"/ingenias/editor/rendererxml/DPDFSMMelINGENIASPanel.xml");
     ...
     */
    public DPDFSMMelRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("DPDFSMMel",current);
    }
  ...
  public static void setEntity(DPDFSMMel ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("DPDFSMMel",ent.getPrefs().getView());
	...
	{
	return RenderComponentManager.retrievePanel("DPDFSMMel",
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("DPDFSMMel",current);
	}
