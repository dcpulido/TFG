...
public class PhaseRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("Phase",
	index,"/ingenias/editor/rendererxml/PhaseUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Phase",
	index,"/ingenias/editor/rendererxml/PhaseINGENIASPanel.xml");
    ...
    return RenderComponentManager.getSize("Phase",current);
    }
  ...
  public static void setEntity(Phase ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Phase",ent.getPrefs().getView());
	...
	{
	return RenderComponentManager.retrievePanel("Phase",
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("Phase",current);
	}
