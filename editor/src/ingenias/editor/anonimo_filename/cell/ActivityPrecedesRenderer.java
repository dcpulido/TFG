...
public class ActivityPrecedesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("ActivityPrecedes",
    index,"/ingenias/editor/rendererxml/ActivityPrecedesNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("ActivityPrecedes",
    index,"/ingenias/editor/rendererxml/ActivityPrecedesINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("ActivityPrecedes",
    index,"/ingenias/editor/rendererxml/ActivityPrecedesLABELPanel.xml");
     ...
     */
     public ActivityPrecedesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("ActivityPrecedes",current);
    }
 ...
 public static void setEntity(ActivityPrecedes ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ActivityPrecedes",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("ActivityPrecedes",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("ActivityPrecedes",c);
    }
