...
public class QRRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("QR",
    index,"/ingenias/editor/rendererxml/QRNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("QR",
    index,"/ingenias/editor/rendererxml/QRINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("QR",
    index,"/ingenias/editor/rendererxml/QRLABELPanel.xml");
    ...
    return RenderComponentManager.getSize("QR",current);
    }
 ...
 public static void setEntity(QR ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("QR",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("QR",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("QR",c);
    }
