...
public class WFConsumesView extends NAryView {

static WFConsumesRenderer renderer1 = new WFConsumesRenderer();

  // Constructor.
  public WFConsumesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.WFConsumes ent=(ingenias.editor.entities.WFConsumes)((DefaultGraphCell)this.getCell()).getUserObject();
