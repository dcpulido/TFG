...
public class StructuralWPRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("StructuralWP",
	index,"/ingenias/editor/rendererxml/StructuralWPUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("StructuralWP",
	index,"/ingenias/editor/rendererxml/StructuralWPINGENIASPanel.xml");
     ...
     */
    public StructuralWPRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("StructuralWP",current);
    }
  ...
  public static void setEntity(StructuralWP ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("StructuralWP",ent.getPrefs().getView());
	...
	{
	return RenderComponentManager.retrievePanel("StructuralWP",
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("StructuralWP",current);
	}
