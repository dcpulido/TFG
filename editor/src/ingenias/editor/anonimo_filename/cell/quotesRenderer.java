...
public class quotesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("quotes",
    index,"/ingenias/editor/rendererxml/quotesNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("quotes",
    index,"/ingenias/editor/rendererxml/quotesINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("quotes",
    index,"/ingenias/editor/rendererxml/quotesLABELPanel.xml");
     ...
     */
     public quotesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("quotes",current);
    }
 ...
 public static void setEntity(quotes ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("quotes",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("quotes",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("quotes",c);
    }
