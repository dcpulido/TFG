...
this.addClass("WFProducessource","ingenias.editor.entities.MentalState");
     
    
     this.addRole("WFProducestarget");
     this.setArity("WFProducestarget",true,1);
     this.setArity("WFProducestarget",false,2147483647);
     
this.addClass("WFProducestarget","ingenias.editor.entities.MentalEntity");
     
this.addClass("WFProducestarget","ingenias.editor.entities.MentalInstanceSpecification");
