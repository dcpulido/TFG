...
public class WFContainsRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
    ...
    RenderComponentManager.loadRenderFile("WFContains",
    index,"/ingenias/editor/rendererxml/WFContainsNOICONPanel.xml");
    
    index=ViewPreferences.ViewType.INGENIAS;
    RenderComponentManager.loadRenderFile("WFContains",
    index,"/ingenias/editor/rendererxml/WFContainsINGENIASPanel.xml");
    
    index=ViewPreferences.ViewType.LABEL;
    RenderComponentManager.loadRenderFile("WFContains",
    index,"/ingenias/editor/rendererxml/WFContainsLABELPanel.xml");
     ...
     */
     public WFContainsRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("WFContains",current);
    }
 ...
 public static void setEntity(WFContains ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFContains",ent.getPrefs().getView());
    ...
    {
    return RenderComponentManager.retrievePanel("WFContains",this.current);
    ...
    public static JPanel setCurrent(ViewPreferences.ViewType c) {
        ...
        return (JPanel) RenderComponentManager.retrievePanel("WFContains",c);
    }
