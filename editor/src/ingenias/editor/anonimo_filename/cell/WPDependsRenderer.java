...
public class WPDependsRenderer extends VertexRenderer implements CellViewRenderer{
	...
	static {
		try {
			...
			RenderComponentManager.loadRenderFile("WPDepends",
												  index,"/ingenias/editor/rendererxml/WPDependsNOICONPanel.xml");
			
			index=ViewPreferences.ViewType.INGENIAS;
			RenderComponentManager.loadRenderFile("WPDepends",
												  index,"/ingenias/editor/rendererxml/WPDependsINGENIASPanel.xml");
			
			index=ViewPreferences.ViewType.LABEL;
			RenderComponentManager.loadRenderFile("WPDepends",
												  index,"/ingenias/editor/rendererxml/WPDependsLABELPanel.xml");
	...
	public WPDependsRenderer() {
    }
	
    public Dimension getSize() {
		return RenderComponentManager.getSize("WPDepends",current);
    }
	...
	public static void setEntity(WPDepends ent){
		Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WPDepends",ent.getPrefs().getView());
	...
	{
		return RenderComponentManager.retrievePanel("WPDepends",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("WPDepends",c);
	}
