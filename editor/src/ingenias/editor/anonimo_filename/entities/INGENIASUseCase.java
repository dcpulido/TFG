...
public class INGENIASUseCase extends UseCase {
	...
	public TypedVector Scenarios=new TypedVector(ingenias.editor.entities.OrganizationModelModelEntity.class);
	...
	public INGENIASUseCase(String id) {
		super(id);
		this.setHelpDesc("<br>This use case is configured with information about preconditions and postconditions, as well as information of the different Organizations that may appear<br>");
		this.setHelpRecom("");
	}
	...
	public void addScenarios(OrganizationModelModelEntity element){
		this.Scenarios.add(element);
	}
	
	public void insertScenariosAt(int pos,OrganizationModelModelEntity element){
		this.Scenarios.insert(element,pos);
	}
	
	public int containsScenarios(OrganizationModelModelEntity element){
