...
public class InteractionModelModelJGraph extends ModelJGraph {
  ...
  protected void creaToolBar() {
    ...
    Image img_IUIterate =
        ImageLoader.getImage("images/it40.gif");
    ...
    Image img_IUConcurrence =
        ImageLoader.getImage("images/conc40.gif");
    ...
    Image img_InteractionUnit =
        ImageLoader.getImage("images/iu40.png");
    ...
    Image img_UMLSpecification =
        ImageLoader.getImage("images/umlspec40.gif");
    ...
    Image img_AUMLSpecification =
        ImageLoader.getImage("images/aumlspec40.gif");
    ...
    Image img_GRASIASpecification =
        ImageLoader.getImage("images/gspec40.gif");
