...
public class RoleDiagramActionsFactory extends DiagramMenuEntriesActionsFactory  implements java.io.Serializable {
	
	public RoleDiagramActionsFactory(GUIResources resources, IDEState state){
